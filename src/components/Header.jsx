    ...
    <div className='w-[95%] mx-auto py-6 flex flex-grow justify-between items-center'>
      ...
      <div className='flex justify-end w-[50%]'>
        <div className='flex justify-between items-center gap-x-3'>
          <div className='hidden md:block text-black rounded-full bg-transparent hover:bg-gray-300 duration-300 cursor-pointer px-1 py-2 truncate'>
            Đón tiếp khách
          </div>
          <div className='hidden md:flex justify-center items-center text-black rounded-full bg-transparent hover:bg-gray-300 duration-300 cursor-pointer px-6 py-3'>
            <svg
              viewBox='0 0 16 16'
          ...
          <Dropdown trigger={["click"]} menu={{ items }} placement='bottomRight'>
            <div className='px-6 py-3 border border-gray-300 rounded-full flex justify-between items-center gap-x-6 hover:shadow-lg hover:shadow-gray-500/50 duration-200 cursor-pointer'>
              <svg
                viewBox='0 0 32 32'
                xmlns='http://www.w3.org/2000/svg'
                aria-hidden='true'
