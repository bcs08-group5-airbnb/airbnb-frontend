...
function LocationConfirmDeleteModal({ closeConfirmDeleteModal, location }) {
      ...
      >
        ...
        <div className="mt-4 mb-6">
          ...
          <p className="text-sm text-gray-700 dark:text-gray-400">
            ...
            <b className="text-primary">{location.tenViTri}</b> ? <br />
            <i>
...
export default LocationConfirmDeleteModal;
