          ...
          <li className='relative px-6 py-3'>
            ...
            <a
              className={`inline-flex items-center w-full text-sm font-semibold ${
                pathname === "/admin" ? "text-gray-800 dark:text-gray-200" : "dark:text-gray-400"
          ...
          <li className='relative px-6 py-3'>
            ...
            <a
              className={`inline-flex items-center w-full text-sm ${
                pathname === "/admin/user" ? "text-gray-800 dark:text-gray-200" : "dark:text-gray-400"
          ...
          <li className='relative px-6 py-3'>
            ...
            <a
              className={`inline-flex items-center w-full ${
                pathname === "/admin/room" ? "text-gray-800 dark:text-gray-200" : "dark:text-gray-400"
