      ...
      <div className='flex-1 h-full max-w-4xl mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800'>
        <div className='flex flex-col overflow-y-auto md:flex-row'>
          <div className='h-32 md:h-auto md:w-1/2'>
            <img aria-hidden='true' className='object-cover w-full h-full dark:hidden' src='/images/create-account-office.jpeg' alt='Office' />
            <img
              aria-hidden='true'
          ...
          <div className='flex items-center justify-center p-6 sm:p-12 md:w-1/2'>
            <div className='w-full'>
              ...
              <p className='mt-4'>
                <a className='text-sm font-medium text-primary dark:text-primary hover:underline' href='./login'>
