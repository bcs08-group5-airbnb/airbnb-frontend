...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-[url('https://raw.githubusercontent.com/bcs08-group5-airbnb/airbnb-frontend/master/public/images/airbnb-travel-bg.jpg')] bg-center bg-cover bg-no-repeat bg-fixed relative">
        ...
        <div className='p-6 m-2 bg-white rounded-lg w-2/3 md:w-1/3 space-y-3'>
          ...
          <Form form={form} layout='vertical' onFinish={onFinish} onFinishFailed={onFinishFailed} autoComplete='off'>
            ...
            <div className='grid lg:flex justify-center items-center gap-3 mt-9'>
              ...
              <button className='cursor-pointer text-white w-full bg-pink-500 hover:bg-pink-700 duration-300 px-6 py-2 rounded-lg'>Đăng nhập</button>
            </div>
          </Form>
